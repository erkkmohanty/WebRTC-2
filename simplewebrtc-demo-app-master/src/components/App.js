...
const App = ({ configUrl, userData, roomName, roomPassword }) => (
  <Provider configUrl={configUrl} userData={userData}>
    ...
    */}
    ...
    addLocalVideo?: (track: MediaStreamTrack, stream: MediaStream) => void;
    shareLocalMedia?: (id: string) => void;
    render?: (getMedia: () => Promise<void>) => React.ReactNode; */}
      <RequestUserMedia audio video auto share />
          ...
          return (
            <StyledUIContainer>
              <StyledToolbar>
                ...
                <UserControls render={({ user, isMuted, mute, unmute, setDisplayName, pauseVideo, resumeVideo, setAudioOutputDevice, setVoiceActivityThreshold }) => (
                  <div>
